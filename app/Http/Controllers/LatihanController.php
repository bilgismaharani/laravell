...
class LatihanController extends Controller
{
    ...
    public function loop(){
        $data = [
            ['Nama'=>'Raka','Kelas'=>'XI RPL 1','uangjajan'=>55000],
            ['Nama'=>'Baihaqi','Kelas'=>'XI RPL 1','uangjajan'=>25000],
            ['Nama'=>'Kintari','Kelas'=>'XI RPL 1','uangjajan'=>15000],
            ['Nama'=>'Nanad','Kelas'=>'XI RPL 1','uangjajan'=>11000],
    ];
    ...
    public function data(){
        $data = [
            ['nama'=>'Bayu','agama'=>'Islam','alamat'=>'Bandung','jenkel'=>'Laki-laki','jabatan'=>'Manager','jamker'=>350],
            ['nama'=>'Raya','agama'=>'Islam','alamat'=>'Bandung','jenkel'=>'Perempuan','jabatan'=>'Sekretaris','jamker'=>250],
            ['nama'=>'Bela','agama'=>'Islam','alamat'=>'Bandung','jenkel'=>'Perempuan','jabatan'=>'Staff','jamker'=>200],
        ];
        foreach ($data as $val => $key) {
            echo 'Nama : '.$key['nama'].'<br>'.
                'Agama : '.$key['agama'].'<br>'.
